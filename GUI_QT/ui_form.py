...
class Ui_main_qwidget(object):
    def setupUi(self, main_qwidget):
        ...
        self.histograma_antes_layout.setSizeConstraint(QLayout.SetFixedSize)
        ...
        self.histograma_despues_layout.setSizeConstraint(QLayout.SetFixedSize)
        ...
        self.foto_antes_layout.setSizeConstraint(QLayout.SetFixedSize)
        ...
        self.foto_despues_layout.setSizeConstraint(QLayout.SetFixedSize)
